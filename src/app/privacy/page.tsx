  ...
  return (
    <>
      ...
      <PolicySection heading="수집 목적과 항목">
        서비스 이용 현황과 비모집 주택 탐색 수요를 파악하기 위해 지도 이용, 모집공고 연결 상태별
        주택 상세 확인, 관심 주택 저장·해제와 모집공고 열람 행동을 기록합니다. 주택 상세 조회
        카운터는 날짜와 모집공고 연결 상태별 합계만 저장하고, 익명 실험 행동에는 실험 버전, 이벤트
        시각과 공개 주택의 위치 ID를 함께 저장합니다.
      </PolicySection>
    </>
  );
}
